...
const translations = {
  ...
  ru: {
    ...
    heroDescription: 'Pulse Maze — браузерная игра для тестирования BLE-пульсометров. Подключите Bluetooth-датчик пульса и проходите лабиринт с помощью сердцебиения',
    ...
    finalDescription: 'Без загрузок. Без аккаунта. Подключите пульсометр и смотрите, как BPM управляет точкой в лабиринте',
    playNow: 'Играть',
